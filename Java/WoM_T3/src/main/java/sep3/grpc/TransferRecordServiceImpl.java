...
import sep3.RequestHandlers.TransferRecordService.ITransferRecordDataService;
...
{
    private final ITransferRecordDataService coreService;

    public TransferRecordServiceImpl(ITransferRecordDataService coreService)
    {
